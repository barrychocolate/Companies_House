...
list_of_packages <- c("rvest", "dplyr", "httr", "xml2", "jsonlite", "DT", "here",
                      "readtext")
>>>>>>> f2e874c60dada28a27758bada8feb081cccee576
...
=======
# Keep API key in separate .txt file for security and load into object as a char string
foz_key <- readtext("C:/AHF/Keys/CH_API_Key.txt")
foz_key <- as.character(foz_key$text)
>>>>>>> f2e874c60dada28a27758bada8feb081cccee576
